;;; window-number.el --- Jump to a window by number

;; Author: Johann "Myrkraverk" Oskarsson <myrkraverk@users.sourceforge.net>
;; URL: http://www.emacswiki.org/emacs/NumberedWindows
;; Version: 1.0
...
; Define C-c C-j 1 to switch to win 1, etc (C-c C-j 0 = win 10)
(unless window-number-mode-map
  (setq window-number-mode-map (make-sparse-keymap))
  ; space after C-j is important
  (window-number-define-keys window-number-mode-map "C-c C-j "))
