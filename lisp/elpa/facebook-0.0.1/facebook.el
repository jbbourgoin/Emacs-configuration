...
(defcustom facebook-session-info 'nil "Your facebook session info.
...
(defun facebook-login ()
  ...
  (let* ((auth-token (facebook-call-function-post "auth.createToken" '()))
    ...
    (read-string "Hit enter here after you've logged into facebook
(this is their lame scheme, not facebook.el's")
